...
PAGES = [
    ...
    "tenancy-parties",          # draft tenancy template builder — step 1 (hand-written)
    "tenancy-property-dates",   # draft tenancy template builder — step 2 (hand-written)
    "tenancy-terms",            # draft tenancy template builder — step 3 (hand-written)
    "tenancy-review",           # draft tenancy template builder — check answers (hand-written)
    "tenancy-template",         # draft tenancy template builder — generated draft (hand-written)
